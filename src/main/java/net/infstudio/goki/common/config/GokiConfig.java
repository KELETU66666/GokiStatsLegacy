...
public class GokiConfig {
    ...
    @Config.Name("Inventory Icon Enabled")
    @Config.Comment({"Should enabled skill icon in inventory tab"})
    public static boolean inventoryIconEnabled = true;
    ...
    @Config.Name("iconYOffset")
    @Config.Comment("Y Offset for LevelUp tabs")
    @Config.RangeInt(min = -500, max = 500)
    public static int iconYOffset = -18;
